...
### 分层架构
Views (视图层) 定义路由级别的组件，负责 UI 渲染，components则是定义可复用的组件<br/>
↓ <br/>
Hooks (业务逻辑层) 定义可复用的逻辑函数，封装业务逻辑<br/>
↓ <br/>
Stores (状态管理层) 单例,定义变量，提供改变变量的方法。单例全局共享<br/>
↓ <br/>
API (接口层) 直接发起http请求<br/>
↓ <br/>
Utils (工具层) 提供各种工具函数，封装常用操作<br/>
